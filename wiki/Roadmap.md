...
> **Note:** Features already shipped are documented on the [[Features]] page and in the [Changelog](https://github.com/pixelnull/sillytavern-DeepLore-Enhanced/blob/main/CHANGELOG.md).
...
| ~~**Entry Clustering / Smart Grouping**~~ | ~~M~~ | ✅ Shipped in 1.0. Hierarchical pre-filter clusters by category; graph has Louvain clustering + gap analysis. |
